...
if ~exist("TimeConsumptionAnalysisFSINDyBased_High_Lorenz96.mat") || isOverwrite
    ...
    for n = 4:20
        ...
        for k = 1:num_of_simulation
            ...
            % [Theta, Charset] = getLib(x, polyorder);
    ...
    save('TimeConsumptionAnalysisFSINDyBased_High_Lorenz96.mat','model', 'record');
else
