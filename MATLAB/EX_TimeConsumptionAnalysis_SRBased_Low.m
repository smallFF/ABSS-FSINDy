...
figpath = './figures/';
isOutputToFile = 1;
baseFileName = 'TimeConsumptionAnalysisSRBased_Low';
isOverwrite = 1;

if ~exist("TimeConsumptionAnalysisSRBased_Low.mat") || isOverwrite
    ...
    save('TimeConsumptionAnalysisSRBased_Low.mat','model', 'record');
else
    load TimeConsumptionAnalysisSRBased_Low
end
